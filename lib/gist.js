...
gist.extractFileName

gist.file=async(url,file="")=>{ 
  
  //Sample https://gist.github.com/anonymous/499816fc316a6440461926b34282b9f0#file-result-md
  var id=extractId(url); 

  
  var gist = await get(`/${id}`);
    
  if(!file) {
    file=extractFileName(url);
  }

  
   file=file||Object.entries(gist.files)[0][0]; return gist.files[file]; }; 
