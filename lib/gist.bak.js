window.gist=(function(require,exports={},module){
  ...
  var gists=exports.gists=(user)=>{
    
    
    var uri=`${baseURL}/users/${user}/gists`
  }
  var post = exports.post = async(endpoint,body,headers=[])=>{
    var opts = {
      url:`${baseURL}url`,
      method:"POST",
  ...
  var get=exports.get=async(endpoint,query,headers=[])=>{
    var opts = {
      url:`${baseURL}url`,
      method:"GET",
      headers: defaultHeaders.concat(headers),
