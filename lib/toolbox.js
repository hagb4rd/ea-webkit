...
var toolbox=module.exports=async()=>{
    var cdn = {
      'hyperhtml':'https://unpkg.com/hyper-html',
    ...
    var btnBookmarklet = $.create('button',{id:'createBtn'});
    ...
    var btn=$.create('button',{id:'bToolbox'});
